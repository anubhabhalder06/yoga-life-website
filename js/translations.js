...
const TRANSLATIONS = {
  en: {
    ...
    // PAGES, SLOTS
    "sp.label": "Schedule & Timings",
    "sp.h1": "Class Slots",
    "sp.sub": "Find the perfect time for your practice, in-studio or online.",
    "sp.tab.off": "Offline (In-Studio)",
    "sp.tab.on": "Online (Live)",
    "sp.off.h3": "Offline (In-Studio) Classes",
    "sp.slots.h": "Available Time Slots",
    "sp.fees.h": "Fee Structure",
    "sp.plan.5days": "5 Days / Week",
    "sp.period.month": "per month",
    "sp.off.l1": "Access to any 5 offline classes weekly",
    "sp.off.l2": "Personalized attention",
    "sp.plan.3days": "3 Days / Week",
    "sp.off.l3": "Access to 3 offline classes weekly",
    "sp.off.l4": "Great for beginners",
    "sp.reg.fee": "* One-time Registration Fee: ₹250 (Applicable for all new members)",
    "sp.on.h3": "Online (Live) Classes",
    "sp.plan.monthly": "Monthly Plan",
    "sp.on.l1": "Unlimited online sessions",
    "sp.on.l2": "HD streaming quality",
    "sp.plan.quarterly": "Quarterly Special",
    "sp.save.200": "Save ₹200",
    "sp.period.3months": "per 3 months",
    "sp.on.l3": "Best value package",
    "sp.activity.label": "Studio Activity",
    "sp.activity.h2": "Popular Times",
    "sp.activity.sub": "See when the studio is typically busy.",
  ...
  bn: {
    ...
    "sp.label": "সময়সূচী",
    "sp.h1": "ক্লাসের স্লট",
    "sp.sub": "স্টুডিওতে বা অনলাইনে আপনার অনুশীলনের জন্য সঠিক সময়টি খুঁজুন।",
    "sp.tab.off": "অফলাইন (স্টুডিওতে)",
    "sp.tab.on": "অনলাইন (লাইভ)",
    "sp.off.h3": "অফলাইন (স্টুডিওতে) ক্লাস",
    "sp.slots.h": "উপলব্ধ সময় স্লট",
    "sp.fees.h": "ফি কাঠামো",
    "sp.plan.5days": "সপ্তাহে ৫ দিন",
    "sp.period.month": "প্রতি মাসে",
    "sp.off.l1": "সপ্তাহে যেকোনো ৫টি অফলাইন ক্লাসে প্রবেশাধিকার",
    "sp.off.l2": "ব্যক্তিগত মনোযোগ",
    "sp.plan.3days": "সপ্তাহে ৩ দিন",
    "sp.off.l3": "সপ্তাহে ৩টি অফলাইন ক্লাসে প্রবেশাধিকার",
    "sp.off.l4": "নতুনদের জন্য দুর্দান্ত",
    "sp.reg.fee": "* এককালীন নিবন্ধন ফি: ₹২৫০ (সমস্ত নতুন সদস্যদের জন্য প্রযোজ্য)",
    "sp.on.h3": "অনলাইন (লাইভ) ক্লাস",
    "sp.plan.monthly": "মাসিক প্ল্যান",
    "sp.on.l1": "সীমাহীন অনলাইন সেশন",
    "sp.on.l2": "এইচডি স্ট্রিমিং গুণমান",
    "sp.plan.quarterly": "ত্রৈমাসিক স্পেশাল",
    "sp.save.200": "২০০ টাকা বাঁচান",
    "sp.period.3months": "প্রতি ৩ মাসে",
    "sp.on.l3": "সেরা ভ্যালু প্যাকেজ",
    "sp.activity.label": "স্টুডিওর কার্যকলাপ",
    "sp.activity.h2": "জনপ্রিয় সময়",
    "sp.activity.sub": "স্টুডিও সাধারণত কখন ব্যস্ত থাকে তা দেখুন।",
